"""Local S&P 500 ticker universe for version 1 validation.

Source checked from the public Wikipedia S&P 500 constituents table on
2026-05-04. S&P membership changes over time, so refresh this list before
using the app for production research.
"""
...
SP500_TICKERS = set(_SP500_SYMBOLS.split(","))


def normalize_ticker(ticker: str) -> str:
    """Normalize common user spellings to S&P display symbols."""
    return ticker.strip().upper().replace("-", ".")


def to_yfinance_ticker(ticker: str) -> str:
    """Convert S&P class-share symbols to yfinance's hyphen convention."""
